...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -2114.5430; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 2082.2589; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -1310.5994; // x position of the perpendicular encoder (in tick units)
    }
